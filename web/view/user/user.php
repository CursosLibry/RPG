         ...
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            ...
            <div class="row">
               <div class="col-lg-6 about-txt-left">
                  <img src="../../images/mestre.png" alt="" class="img-fluid">
               </div>
            ...
            <div class="row">
               <div class="col-lg-6 about-txt-left">
                  ...
                  <div class="info-sub-w3">
                     <p>Se prepare para traçar sua jornada em diversos universos, em épocas diferentes, com os mais variados oponentes e vilões, ou se prepare para aguentar aquele amigo que sempre tira 1 no d20 e estraga a estratégia do time inteiro em uma única ação.</p>
                     <p class="pt-2">Se você ainda tem vontade de prosseguir <spam id="mostraMenuParaJogador" style="cursor: pointer; font-weight: bold;">Clique aqui</spam> e comece sua jornada.</p>
                  </div>
                  <!-- <div class="abut-fst-img pt-3">
                     <img src="../../images/ab2.jpg" alt=" " class="img-fluid">
                     <div class="abut-secound-img">
               ...
               <div class="col-lg-6 about-txt-right">
                  <img src="../../images/jogador.png" alt="" class="img-fluid">
               </div>
         ...
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            ...
            <div class="row text-center">
               ...
               <div class="col-md-4 service-icon-agile">
                  ...
                  <div class="address-left text-center">
                     <a href="../../view/user/editUser.php"><span class="fas fa-cubes"></span></a>
                  </div>
                  <div class="address-right">
                     <p class="pt-2">Bom, você existe né? Então nessa seção você pode editar seus dados pessoias, sua imagem de perfil e adicionar aquela frase, em seu status, que amedronta até o mais corajoso cavalheiro.
                     </p>
